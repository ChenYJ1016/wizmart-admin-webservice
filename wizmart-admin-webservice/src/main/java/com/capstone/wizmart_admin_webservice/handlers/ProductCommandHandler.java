...
public class ProductCommandHandler {
    ...
    public void handleCreateProductCommand(CreateProductCommand command) {
        ...
        event.setPayload(String.format("Product created with name %s %s %f %d", command.getName(), command.getDescription(), command.getPrice(), command.getQuantity()));
    ...
    public void handleUpdateProductCommand(UpdateProductCommand command) {
        ...
        event.setPayload(String.format("Product %s updated with name %s %s %f %d", command.getProductId(), command.getName(), command.getDescription(), command.getPrice(), command.getQuantity()));
        eventRepository.save(event);
